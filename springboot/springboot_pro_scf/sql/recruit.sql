...
MySQL - 5.7.24 : Database - tensquare_recruit
*********************************************************************
*/
...
insert  into `tb_enterprise`(`id`,`name`,`summary`,`address`,`labels`,`coordinate`,`ishot`,`logo`,`jobcount`,`url`) values ('','传智播客','国内著名IT教育机构','金燕龙办公楼','IT 培训','1019,2223','1',NULL,NULL,NULL),('2','小米','手机厂商','中关村软件园','手机','0211,3333','0',NULL,NULL,NULL);
